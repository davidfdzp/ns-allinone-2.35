...
# installed.
TK_PREFIX='/home/david/ns-allinone-2.35-git'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/david/ns-allinone-2.35-git'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/david/ns-allinone-2.35-git/tk8.5.10/unix -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/david/ns-allinone-2.35-git/lib -ltk8.5'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/david/ns-allinone-2.35-git/include'
...
# compiled.
TK_SRC_DIR='/home/david/ns-allinone-2.35-git/tk8.5.10'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/david/ns-allinone-2.35-git/tk8.5.10/unix -ltkstub8.5'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/david/ns-allinone-2.35-git/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/david/ns-allinone-2.35-git/tk8.5.10/unix/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/david/ns-allinone-2.35-git/lib/libtkstub8.5.a'
